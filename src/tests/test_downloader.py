...
def downloader() -> Downloader:
    """
    Fixture that provides Downloader instance for tests.
    :return: Downloader instance for tests.
    """
...
async def test_download_valid_links(url: str, downloader: Downloader) -> None:
...
async def test_download_invalid_urls(url: str, downloader: Downloader) -> None:
...
async def test_download_url_invalid_input_types(invalid_input, downloader: Downloader) -> None:
    """Test for downloading videos with invalid YouTube URLs."""
...
async def test_download_video_invalid_qualities(invalid_input, downloader: Downloader) -> None:
    """Test for downloading videos with invalid video qualities."""
    assert (await downloader.download_video("https://youtu.be/dQw4w9WgXcQ?si=52ngrNGc_WNyEkUb",
                                            invalid_input) == "Incorrect video quality.")


@pytest.mark.asyncio
async def test_download_empty_url(downloader: Downloader) -> None:
    """Test that empty string is rejected while downloading."""
    assert await downloader.download_video("", 144) == "Invalid link provided."


@pytest.mark.asyncio
async def test_download_empty_quality(downloader: Downloader) -> None:
    """Test that empty string is rejected while downloading."""
    assert (await downloader.download_video("https://youtu.be/dQw4w9WgXcQ?si=52ngrNGc_WNyEkUb",
...
@pytest.mark.asyncio
@pytest.mark.parametrize("url", VALID_YOUTUBE_URLS)
async def test_download_audio_valid_links(url: str, downloader: Downloader) -> None:
...
@pytest.mark.asyncio
@pytest.mark.parametrize("url", INVALID_YOUTUBE_URLS)
async def test_download_audio_invalid_urls(url: str, downloader: Downloader) -> None:
...
@pytest.mark.asyncio
@pytest.mark.parametrize("invalid_input", [None, 123, 12.34])
async def test_download_audio_url_invalid_input_types(invalid_input, downloader: Downloader) -> None:
    """Test for downloading audio with invalid YouTube URLs."""
...
async def test_download_video_invalid_formats(invalid_input, downloader: Downloader) -> None:
    """Test for downloading audio with invalid audio formats."""
    assert (await downloader.download_audio("https://youtu.be/dQw4w9WgXcQ?si=52ngrNGc_WNyEkUb",
                                            invalid_input) == "Incorrect audio format.")


@pytest.mark.asyncio
async def test_download_audio_empty_url(downloader: Downloader) -> None:
    """Test that empty string is rejected while downloading."""
    assert await downloader.download_audio("", "mp3") == "Invalid link provided."


@pytest.mark.asyncio
async def test_download_audio_empty_quality(downloader: Downloader) -> None:
    """Test that empty string is rejected while downloading."""
    assert (await downloader.download_audio("https://youtu.be/dQw4w9WgXcQ?si=52ngrNGc_WNyEkUb",
